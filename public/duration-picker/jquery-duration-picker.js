        ...
        this.each(function (i, mainInput) {
            ...
            function buildDisplayBlock(id, hidden) {
                return '<div class="bdp-block '+ (hidden ? 'hidden' : '') + '">' +
                            '<span id="bdp_'+ id +'" name="bdp_'+ id +'"></span><br>' +
            ...
            function updateMainInputReplacer() {            	
                $mainInputReplacer.find('#bdp_days').text(totalDuration.days());
                $mainInputReplacer.find('#bdp_hours').text(totalDuration.hours());
                $mainInputReplacer.find('#bdp_minutes').text(totalDuration.minutes());
                $mainInputReplacer.find('#bdp_seconds').text(totalDuration.seconds());
