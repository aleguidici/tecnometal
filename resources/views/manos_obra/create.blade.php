...
@section('title')
Crear especificación de mano de obra
@endsection
...
@section('content')
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <h1 class="box-title">Tecnometal - Nueva Especificación de Mano de Obra</h1>
        </div>
        <div class="box-body">
            <div class="text-info">(*) Campos obligatorios</div>
            <br>
            <form role="form" action="{{route('manos_obra.store')}}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-xs-7">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" maxlength="100" placeholder="Nombre" name="name" value="{{old('name')}}">
                        </div>
